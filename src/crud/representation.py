...
class RepresentationManager:
    ...
    async def save_representation(
        ...
        Returns:
            The number of conclusions admitted to the collection.
        """
        ...
        # dominate the representation. The count is a short, DB-only read
        # closed before the embedding call below; dropping surplus here also
    ...
    async def _apply_session_observation_cap(
        ...
        incoming batch once the cap is reached. A cap of 0 disables the limit.
        """
